...
Board::Board() {
	...
	Piece* p_ptr{};
	tempPos.setpos("D4");
	m_board[4][3] = new King('K', Color::Black, tempPos);
	tempPos.setpos("C8");
	m_board[0][2] = new Rook('R', Color::White, tempPos);
	tempPos.setpos("E8");
	m_board[0][4] = new Rook('R', Color::White, tempPos);
	tempPos.setpos("A5");
	m_board[3][0] = new Rook('R', Color::White, tempPos);
	tempPos.setpos("A1");
	m_board[7][0] = new Rook('R', Color::White, tempPos);
	tempPos.setpos("H1");
	m_board[7][7] = new King('K', Color::White, tempPos);
	//for (int i = 0; i < SIZE_BOARD; i++) {
	//	for (int j = 0; j < SIZE_BOARD; j++) {
